...
public class AutoPilot extends Command {
  ...
  // motion profile for x, y, theta
  // calculate ff vel in x, y, omega
  // calculate fb in x, y, omega

  public AutoPilot(BreakerSwerveDrivetrain drivetrain, AutoPilotConfig autoPilotConfig) {
