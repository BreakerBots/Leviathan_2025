...
public class DriveToPose2 extends Command {
  ...
  public DriveToPose2(Drivetrain drivetrain, TipProtectionSystem tipProtectionSystem, Supplier<Pose2d> target) {
  ...
  public DriveToPose2(Drivetrain drivetrain, TipProtectionSystem tipProtectionSystem, Supplier<Pose2d> target, NavToPoseConfig config) {
  ...
  public DriveToPose2(Drivetrain drivetrain, TipProtectionSystem tipProtectionSystem, Supplier<Pose2d> target, Supplier<Pose2d> robot, NavToPoseConfig config) {
